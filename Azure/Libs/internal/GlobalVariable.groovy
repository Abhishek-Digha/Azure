...
public class GlobalVariable {
    ...
    /**
     * <p>Profile QAS-CA : Explicit Wait Timeout
...
Profile STG-US : Explicit Wait Timeout</p>
    ...
    /**
     * <p>Profile QAS-CA : Adding canada projects
...
Profile STG-US : Adding US projects</p>
    ...
    /**
     * <p>Profile QAS-CA : Adding new team member 
...
Profile STG-US : Adding new team member </p>
    ...
    /**
     * <p>Profile QAS-CA : Adding Credit Card payment details 
...
Profile STG-US : old score version of Transit</p>
    ...
    static {
        ...
        allVariables.put('STG-US', allVariables['default'] + ['url' : 'https://www.stg.arconline.io', 'userName' : 'saurav@groupten.com', 'password' : 'LEEDg10', 'timeOut' : 40, 'env' : 'ARCDataTemplete/ArcTest.xlsx', 'BuildingSheet' : 'USBuildingProject', 'BuildingTeam' : 'BTeam', 'CCPayment' : 'Payment', 'rowNumTwo' : 2, 'rowNumThree' : 3, 'rowNumFour' : 4, 'rowNumFive' : 5, 'rowNumSix' : 6, 'CitySheet' : 'USCityProject', 'CommunitySheet' : 'USCommunityProject', 'CDataInput' : 'CDataInput', 'PortfoliosSheet' : 'Portfolio', 'rowNumSeven' : 7, 'rowNumEight' : 8, 'BDataInput' : 'BDataInput', 'TeamMember' : 'stg-01@gmail.com', 'adminUrl' : 'stg.app.arconline.io/admin', 'adminUserName' : 'stggbciadmin@gbci.com', 'adminPassword' : 'initpass', 'rowNumTwentyOne' : 21, 'rowNumTwentyTwo' : 22, 'notCertified' : 'notCertified', 'rowNumTwentyThree' : 23, 'rowNumNine' : 9, 'teamMemName' : 'Saurav K', 'ExcelTemplateData' : 'ExcelTemplateDataVerificationSheet.xlsx', 'TemplateEnergyData' : 'Energy', 'TemplateWaterData' : 'Water', 'TeamMemberPassword' : 'initpass', 'TemplateWasteData' : 'Waste', 'rowNumTen' : 10, 'AllProjectUrl' : 'https://stg.app.arconline.io/app/projects/my-projects/?project-type=all', 'TemplateHE' : 'HumanExp'])
