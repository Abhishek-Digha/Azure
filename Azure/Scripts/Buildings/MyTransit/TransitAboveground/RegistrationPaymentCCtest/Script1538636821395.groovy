...
//Payment by Credit Card Test (Using 50% promocode)
	...
	try {
			...
			//CustomKeywords.'com.arc.ReusableMethods.ReusableMethodsPayment.regPaymentUsingPromocode'(GlobalVariable.BuildingSheet, GlobalVariable.rowNumThree)
